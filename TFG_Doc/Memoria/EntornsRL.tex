...
\begin{enumerate}
  ...
  \item \textbf{Capa Gymnasium} (\texttt{TrucGymEnv} / \texttt{TrucGymEnvMa}): adapta
        ...
        les biblioteques d'\ac{SB3} la puguin entrenar sense saber res del Truc. A
...
\begin{figure}[H]
  ...
  \end{tikzpicture}
  \caption[Capes de l'entorn.]{Capes de l'entorn. \texttt{TrucEnvMa} i \texttt{TrucGymEnvMa} segueixen
...
(entre 6 i 20~passos aproximadament). Aquesta variant és clau per al
...
\begin{itemize}
  \item \textbf{Entorn de sessió} (\emph{TrucGymEnvSessio}): l'episodi agrupa $N$
        ...
        (memòria entre mans amb \emph{RecurrentPPO}).
