...
d'informació parcial (formalment, un \acs{POMDP}) especialment exigent per a la
intel·ligència artificial i, alhora, en un patrimoni cultural amenaçat per la dificultat
creixent de reunir-hi jugadors. Aquest treball desenvolupa i avalua agents d'aprenentatge
per reforç profund capaços de jugar al Truc de manera competitiva, partint de zero i sense
coneixement previ, en la variant d'un contra un sense senyes.

El treball s'articula en tres parts. Primer es construeix un simulador complet del joc amb
arquitectura \acs{MVC}, jugable per humans i exposat com a entorn estàndard compatible amb
...
incremental de sis fases, cadascuna guiada per una hipòtesi que condiciona la següent: una
...
preentrenament supervisat, memòria recurrent amb un \emph{pool} d'oponents, \emph{self-play}
...
d'aprenentatge: entrenar primer sobre mans individuals eleva el \acs{PPO} del 3{,}8\% al
84{,}8\% de win-rate ponderat, i un cos convolucional preentrenat i congelat arriba al
