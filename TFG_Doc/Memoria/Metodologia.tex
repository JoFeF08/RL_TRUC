...
un agent aleatori (l'agent aleatori) i 100~partides contra l'agent basat en regles
(l'agent basat en regles). Per evitar el biaix posicional (ser \emph{mà} dona un lleuger
...
Cada terme compleix una funció diferent. L'l'agent basat en regles (pes 0{,}75) és l'oponent
