...
entrenements nous amb COS i dos amb \ac{MLP} sobre mans; les quatre sèries \ac{MLP} de control i
...
\begin{figure}[H]
  ...
  \caption[Win-rate per posició dins la sessió (Fase~4).]{Win-rate per posició dins la sessió (mà~1 a mà~5) per als dos runs de la
...
\begin{table}[H]
  ...
  \begin{tabular}{llrr}
    \toprule
    Run & Memòria & Pic \(\text{metric}\) (12M) & Temps \\
    \midrule
