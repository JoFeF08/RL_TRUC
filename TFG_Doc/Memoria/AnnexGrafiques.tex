...
\begin{figure}[H]
  ...
  \caption[Throughput dels quatre algorismes (M passos/hora).]{Velocitat d'entrenament en milions de passos per hora de càlcul.
...
\begin{figure}[H]
  ...
  \caption[Grup de control de la Fase~2 (24M passos en partides, sense currículum).]{Grup de control de la Fase~2: entrenament directament sobre partides senceres
           ...
           supera el 50\% contra l'agent basat en regles; els altres tres no depassem el 25\%.}
...
% ---------------------------------------------------------------
\section{Bloc 3: Robustesa i equilibri de Nash}
% ---------------------------------------------------------------

\subsection{Fase 6: \acs{NFSP}}


% ---------------------------------------------------------------
\section{Selecció del model de desplegament (Checkpoint~3)}
% ---------------------------------------------------------------
...
\begin{figure}[H]
  ...
  \caption[Calibració estratègica dels candidats del Checkpoint~3.]{Calibració truc (esquerra) i envit (dreta) dels cinc candidats.
           Tots presenten la mateixa tendència: menys truc amb mans fortes
           (comportament de farol) i més envit amb puntuació alta.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/resultats/accio_x_forca_barres.pdf}
  \caption[Probabilitat d'obrir truc i envit per força de mà (barres).]{Probabilitat mitjana d'obrir truc i d'obrir envit per franja de
           força de mà. El truc és màxim amb mans febles (95\%) i disminueix
           amb mans fortes (farol); l'envit segueix el patró invers.}
  \label{fig:ann-res-barres}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Calibració estratègica del model desplegat.]{Calibració estratègica del model final. Esquerra: taxa d'obrir truc
           per franja de força; la tendència decreixent confirma el comportament
           de farol (més truc amb mans febles). Dreta: taxa d'obrir envit per
           puntuació d'envit; creix monotònicament, indicant una política ben
           calibrada per a l'envit.}
...
\begin{figure}[H]
  ...
  \caption[Perfil d'estil emergent del model desplegat (diagrama de radar).]{Perfil d'estil emergent del model desplegat (vermell) comparat amb
           l'agent basat en regles equilibrat (blau). El model és molt més
           agressiu al truc (obre i reapuja molt) i menys a l'envit.}
